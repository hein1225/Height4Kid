...
- **BoxSync（公共服务区）** - 开箱即用的公共云同步服务，无需配置服务器
- **BoxSync（私有服务器）** - 支持自建 BoxSync 私有云，数据完全自主掌控
...
### v1.1.0 (2026-06-04) - 云同步版本

- ☁️ **重磅功能：云同步** - 支持多设备数据实时同步
  - **BoxSync（公共服务区）** - 开箱即用的公共云同步，服务器地址 `https://sync.hyc5069.top/`
  - **BoxSync（私有服务器）** - 支持自建 BoxSync 私有云，数据完全自主掌控
...
- ⚠️ **公共服务器提示** - 使用公共服务区时显示安全提示，建议定期本地备份
